...
/**
 * Class UserLoginCondition
 */
class UserLoginCondition implements ConditionInterface
{
	...
	{
		return $this->acceptedLoginStatus == static::STATUS_LOGGED_IN && BE_USER_LOGGED_IN ||
			$this->acceptedLoginStatus == static::STATUS_LOGGED_OUT && !BE_USER_LOGGED_IN;
	}
